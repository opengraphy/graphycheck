...
//     >
//       <div class="infoContainer" id="infoContainer" style="margin-bottom: 8px">
//         <div class="keyApproval" style="top: 12px">
//           <p>Clé API enregistrée</p>
//           <button id="closeInfo">
//             <svg
...
//         </div>
//       </div>
//       <h3 class="test">Configurer la clé API</h3>
...
//         />
//         <button id="toggleApiKeyVisibility" class="hideButton">
...
//       </div>
//       <div>
//         <button id="saveApiKey" class="confirmButton">Enregistrer</button>
//         <button id="resetApiKey" class="deleteButton">Supprimer</button>
//       </div>
//     </div>
...
// // Écoute les messages provenant du background.js
// chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
//   if (message.action === "open_popup") {
//     createCustomPopup();
//     sendResponse({ status: "Popup ouvert" });
//   }
// });
